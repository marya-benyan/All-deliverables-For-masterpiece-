...
const TrandyProducts = () => {
  ...
  useEffect(() => {
    const fetchTrandyProducts = async () => {
      try {
        const response = await getProducts({ sort: 'best rating', limit: 8, page: 1 });
        ...
        toast.error('Failed to fetch trendy products', { position: 'top-right' });
        setProducts([]);
      } finally {
        setLoading(false);
      }
      ...
      <div className="container mx-auto px-4">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow-md p-12 text-center max-w-md mx-auto">
            ...
            <p className="text-gray-600">New paintings will be added soon, please check back later.</p>
          </div>
        ) : (
